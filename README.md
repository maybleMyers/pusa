...
python ./demos/cli_test_ti2v_release.py \
  ...
  --num_steps 30
```
Note: We suggest you to try different `con_position` here, and you may also modify the level of noise added to the condition image. You may get some surprises.
