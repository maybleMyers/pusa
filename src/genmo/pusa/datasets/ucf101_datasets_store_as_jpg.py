...
class UCF101(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {'video': video, 'video_name': path.split('/')[-1].split('.avi')[0]}
...
# Import your video_transforms and UCF101 dataset class here
# from your_library import video_transforms, UCF101
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data-path", type=str, default="/media/hdd/yfliu/datasets/UCF101/UCF-101")
    ...
    ffs_dataloader = Data.DataLoader(dataset=ffs_dataset, batch_size=1, shuffle=False, num_workers=8)
